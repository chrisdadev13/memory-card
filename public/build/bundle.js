    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			h20 = element("h2");
    			h20.textContent = "Game finished!! Congratulations";
    			t1 = space();
    			h21 = element("h2");
    			t2 = text("This is your score: ");
    			t3 = text(/*score*/ ctx[1]);
    			t4 = space();
    			button = element("button");
    			button.textContent = "Restart";
    			add_location(h20, file$1, 91, 6, 2138);
    			add_location(h21, file$1, 92, 6, 2185);
    			attr_dev(button, "class", "svelte-1rujqzh");
    			add_location(button, file$1, 93, 6, 2228);
    			attr_dev(div, "id", "modal");
    			attr_dev(div, "class", "svelte-1rujqzh");
    			add_location(div, file$1, 90, 4, 2115);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, h20);
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			button.textContent = "Restart";
    			attr_dev(button, "class", "svelte-1rujqzh");
    			add_location(button, file$1, 88, 4, 2053);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 85, 2, 1948);
    			attr_dev(main, "class", "svelte-1rujqzh");
    			add_location(main, file$1, 84, 0, 1939);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
